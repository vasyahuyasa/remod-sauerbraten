...
#define ulonglong2double(A) ((longlong) A >= 0 ? ((double) (longlong) A) : (18446744073709551616.0 + (double) (longlong) A))
#endif
...
#define double2ulonglong(A) (A - (double) 0x8000000000000000ULL >= 0 ? ((ulonglong) A - (double) 0x8000000000000000ULL) + 0x8000000000000000ULL : (ulonglong) A)
#endif
...
#define HAVE_STRTOUL
#endif
#ifndef __GNUC__ //wiill be defined later
